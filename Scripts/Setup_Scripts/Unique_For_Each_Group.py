...
only_control_df.to_csv('Resources/Intermediary_Data/Somatic_Mutations_only_in_control.csv', sep=',')

only_case_df = all_mutations_df[only_case_mutated]
only_case_df.to_csv('Resources/Intermediary_Data/Somatic_Mutations_only_in_case.csv', sep=',')
